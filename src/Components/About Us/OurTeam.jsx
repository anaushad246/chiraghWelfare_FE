...
function OurTeam() {
  return (
    <section id='OurTeam'className='flex flex-col items-center text-center pt-4 px-4' >
          ...
          <table className=" shadow-lg rounded-lg border border-gray-200">
            ...
            <tbody>
              {[
                ...
                { name: 'SANAULLAH SIDDIQUI', designation: 'Secretary' },
                { name: 'QUAMAR HUSNAIN', designation: 'Joint Secretary' },
                { name: 'MD JAMAL SARIF', designation: 'Treasurer' },
                ...
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="py-2 px-4 border-b border-gray-200">{member.designation}</td>
                </tr>
              ))}
            </tbody>
          </table>
